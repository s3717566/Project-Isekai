...
public class ItemController
{
    ...
    public void populateItems () {
        ...
        itemList.Add (new Item (i++, "a fucking stick", "exact what it says it is. Thing has to be at least 3m long.", Item.ItemType.Weapon, 1, IconController.Instance.bootsSprite));
        itemList.Add (new Item (i++, "dung", "exact what it says it is. Thing has to be at least 3m long.", Item.ItemType.MobDrop, 1, IconController.Instance.helmetSprite));
